...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var client, db_1, students, _loop_1, index, studentsWithNoProjects, projects, index, student, timeindex, project, _loop_2, times_1, times_1_1, time, e_1_1, error_1;
        var e_1, _a;
        var _this = this;
                ...
                case 12:
                    _loop_2 = function (time) {
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0: return [4 /*yield*/, getStudentsWithProjectResult(time, db_1.collection("projects"))];
                                case 1:
                                    projects = _c.sent();
                                    console.log(students);
                                    _loop_3 = function (index) {
                                        var project, voted_students;
                                        var _d;
                                        return __generator(this, function (_e) {
                                            switch (_e.label) {
                                                case 0:
                                                    ...
                                                    return [4 /*yield*/, db_1
                                                            .collection("users")
                                                            .find({ projects: (_d = {}, _d[time] = project._id, _d) })
                                                            .toArray()];
                                                case 1:
                                                    voted_students = _e.sent();
                                                    console.log(voted_students.length);
                                                    voted_students.forEach(function (student) {
                    ...
                    _b.label = 13;
                case 13:
                    _b.trys.push([13, 18, 19, 20]);
                    times_1 = __values(times), times_1_1 = times_1.next();
                    _b.label = 14;
                case 14:
                    if (!!times_1_1.done) return [3 /*break*/, 17];
